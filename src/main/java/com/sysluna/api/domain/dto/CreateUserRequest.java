...
public class CreateUserRequest {
  ...
  @Schema(description = "Tenant id to create the user in. Ignored unless the caller is a "
      + "platform admin - everyone else always creates users in their own tenant.")
